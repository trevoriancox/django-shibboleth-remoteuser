...
#Set to False if you don't want to set an unusable password when the user logs in.
SET_UNUSABLE_PASSWORD = getattr(settings, 'SHIBBOLETH_SET_UNUSABLE_PASSWORD', True)

USERNAME_TRANSLATIONS = getattr(settings, 'SHIBBOLETH_USERNAME_TRANSLATIONS', {})
